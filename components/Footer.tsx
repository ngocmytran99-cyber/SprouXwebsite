        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
             ...
             <ul className="space-y-4 text-sm">
                ...
                <li><button onClick={() => onNavigate('help-desk')} className="hover:text-primary transition-colors">Help Desk</button></li>
             </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium">
           <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              <button 
                ...
                className="flex items-center gap-1.5 opacity-20 hover:opacity-100 transition-all duration-300 text-slate-500 hover:text-primary py-1 px-2 rounded hover:bg-white/5"
                title="Admin Control Panel"
              >
                <ShieldCheck size={14} className="text-slate-500 group-hover:text-primary" />
